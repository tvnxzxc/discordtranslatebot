...
- `translatebot/store.py` — `data/store.json`: sunucu ayarları, kullanıcı dilleri, IGN'ler, istatistik; atomik yazım.
...
- `translatebot/cogs/ign.py` — `/ign set|remove|show|setfor`.
